...
const InformationVideo = () => {
  return (
    <div className="wrapper container wrap-introduce-website">
      <h2 style={{ fontSize: "30px" }}>Truyền thông nói gì về HealthCare</h2>
      <div className="wrapper-content introduce-website">
        <iframe
          width="560"
          height="315"
